...
<form class="category_add_form clearfix" action="<?php echo U('authedit');?>" method="post" onsubmit="return Juuz.ajaxForm(this);">
<div class="ui_col_10" style="padding:10px 20px 20px">
    ...
    <?php switch($info["level"]): case "0": ?><input type="hidden" name="module" value="<?php echo ($info["module"]); ?>">
            ...
            <?php case "1": ?><input type="hidden" name="module" value="<?php echo ($info["module"]); ?>">
