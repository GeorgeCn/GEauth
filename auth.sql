...
CREATE TABLE IF NOT EXISTS `think_admin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=gbk COMMENT='后台用户表';

-- 正在导出表  tp.think_admin 的数据：4 rows
...
REPLACE INTO `think_admin` (`id`, `loginname`, `pwd`, `mobile`, `email`, `avatar`, `states`, `last_login_time`, `last_login_ip`, `create_time`) VALUES
	(1, 'admin', '32ad489198552f45b73674ccf256afb5', '15699999999', '123456@qq.com', '', 1, '0000-00-00 00:00:00', '127.0.0.1', '0000-00-00 00:00:00'),
	...
	(5, 'glx', '32ad489198552f45b73674ccf256afb5', '15677777777', '123@qq.com', 'Public/Uploads/avatars/2017-05-09/59118f46a7477.jpg', 2, '2017-05-09 17:43:34', '', '0000-00-00 00:00:00');
...
REPLACE INTO `think_auth_group` (`id`, `title`, `desc`, `status`, `rules`, `create_time`) VALUES
	(1, '超级管理员', '', 1, '1', '0000-00-00 00:00:00'),
...
-- 正在导出表  tp.think_auth_group_access 的数据：2 rows
...
-- 正在导出表  tp.think_auth_rule 的数据：3 rows
...
REPLACE INTO `think_auth_rule` (`id`, `name`, `title`, `type`, `status`, `condition`, `pid`) VALUES
	(1, 'home/index/index', '后台首页', 1, 1, '', 0),
	(2, 'home/user/index', '用户首页', 1, 1, '', 0),
	(3, 'home/user/useradd', '用户组', 1, 1, '', 2);
